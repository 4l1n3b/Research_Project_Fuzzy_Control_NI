...
Gs_22 = tf([22.222*k], [180 1],'InputDelay',16);
...
% Gs_12_mf = feedback(Gs_12, 1);
% Gs_21_mf = feedback(Gs_21, 1);
% figure(1)
% step(Gs_11_mf)
% figure(2)
% step(Gs_12_mf)
...
% [yt_degrau, t_step] = step(amplitude_degrauT * Gs_11_mf+Gs_12_mf, tt);
% 
