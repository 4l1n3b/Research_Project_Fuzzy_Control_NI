...
% dados = readtable('planilhas/dados_PID_astrom_SISO_umidade.csv');
dados = readtable('planilhas/dados_PID_ZN_SISO_umidade.csv');
...
% ---- P1 ----
p1_umid = calc_metrics(y_2umid(lim_p1:lim_p2), u_2umid(lim_p1:lim_p2), erro2umid(lim_p1:lim_p2),Tempo(lim_p1:lim_p2), 'Umidade', '55%');
...
% ---- P3 ----
p3_umid = calc_metrics(y_2umid(lim_p3+1:Qde_amostras), u_2umid(lim_p3+1:Qde_amostras), erro2umid(lim_p3+1:Qde_amostras),Tempo(lim_p3+1:Qde_amostras), 'Umidade', '50%');
